...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', type=str, default='runs/train/trains_lr1/weights/best.pt', help='initial weights path')
    parser.add_argument('--weights', type=str, default='runs/train/best_basic/weights/best.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str, default='prunModels/yolov5s-pruning.yaml', help='model.yaml')
    parser.add_argument('--data', type=str, default='data/data3.yaml', help='data.yaml path')
    ...
    parser.add_argument('--path', type=str, default='models/yolov5s-visdrone-pruned.yaml',
    ...
    model.load_state_dict(state_dict, strict=False)  # load strictly; initially is True;
