...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default= '/home/yushen/Desktop/YOLOv5-Multibackbone-Compression/yolov5x.pt',
    ...
    model.load_state_dict(state_dict, strict=False)  # load strictly
