    ...
    if cuda and RANK != -1:
        model = DDP(model, device_ids=[LOCAL_RANK], output_device=LOCAL_RANK, \
                    find_unused_parameters=any(isinstance(layer, nn.MultiheadAttention) for layer in
                                               model.modules()))  # <--- due to multihead attn
...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default='/home/yushen/Desktop/YOLOv5-Multibackbone-Compression/yolov5s-Slimpruned.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/data3.yaml', help='dataset.yaml path')
